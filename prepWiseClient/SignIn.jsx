        ...
        <View style={styles.overlay}>
          <CustomPopup
            ...
            onDismiss={() => {
              setTimeout(() => {
                if (isAdmin) {
                  navigation.navigate("AdminScreen"); //  אם אדמין
                } else if (isMentor) {
                  navigation.navigate("HomePageMentor"); //  אם מנטור
                } else {
                  navigation.navigate("HomePage"); //  אחרת רגיל
                }
              }, 150);
      ...
      style={styles.logo}/> */}
        <View style={appliedStyles.loginBox}>
          ...
          >
            ...
            <Text
              style={appliedStyles.CreateAccounttext}
          ...
          <TouchableOpacity
            ...
            onPress={() => loginAsUser(email, password)}
          >
